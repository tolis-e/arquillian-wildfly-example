# Arquillian WildFly Example [![Build Status](https://travis-ci.org/tolis-e/arquillian-wildfly-example.png)](https://travis-ci.org/tolis-e/arquillian-wildfly-example)
